...
proc init_gui { IPINST } {
  ...
  set NUM_UNITS [ipgui::add_param $IPINST -name "NUM_UNITS"]
  set_property tooltip {Number of synthesizer units.} ${NUM_UNITS}
  ipgui::add_param $IPINST -name "BITWIDTH" -widget comboBox

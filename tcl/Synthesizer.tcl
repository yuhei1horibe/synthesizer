...
#
# Synthesizer.tcl: Tcl script for re-creating project 'Synthesizer'
#
# Generated by Vivado on Wed Dec 23 15:22:24 PST 2020
...
#
# 1. This project restoration tcl script (Synthesizer.tcl) that was generated.
#
...
set _xil_proj_name_ "Synthesizer"
...
set script_file "Synthesizer.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../Synthesizer"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$::env(HOME)/.Xilinx/Vivado/2019.2/xhub/board_store"]" -objects $obj
...
set file "hdl/synthesizer_bd_wrapper.v"
...
set_property -name "top" -value "synthesizer_bd_wrapper" -objects $obj
...
set_property -name "target_constrs_file" -value "[get_files *new/synth_io.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/synth_io.xdc]" -objects $obj
...
# Proc to create BD synthesizer_bd
proc cr_bd_synthesizer_bd { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name synthesizer_bd
  ...
  set i2s_lrck_0 [ create_bd_port -dir O i2s_lrck_0 ]
  set i2s_mclk_0 [ create_bd_port -dir O i2s_mclk_0 ]
  set i2s_tx_0 [ create_bd_port -dir O i2s_tx_0 ]
  set iic_addr [ create_bd_port -dir O -from 1 -to 0 iic_addr ]
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {146.903} \
   CONFIG.CLKOUT1_PHASE_ERROR {119.384} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {98.304} \
  ...
  # Create instance: my_synth_0, and set properties
  set my_synth_0 [ create_bd_cell -type ip -vlnv user.org:user:my_synth:1.0 my_synth_0 ]
  set_property -dict [ list \
  ...
  # Create instance: rst_clk_wiz_0_98M, and set properties
  set rst_clk_wiz_0_98M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_wiz_0_98M ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins my_synth_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net axi_iic_0_gpo [get_bd_ports iic_addr] [get_bd_pins axi_iic_0/gpo]
  connect_bd_net -net axi_iic_0_iic2intc_irpt [get_bd_pins axi_iic_0/iic2intc_irpt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins my_synth_0/s00_axi_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins rst_clk_wiz_0_98M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_98M/dcm_locked]
  connect_bd_net -net my_synth_0_i2s_bclk [get_bd_ports i2s_bclk_0] [get_bd_pins my_synth_0/i2s_bclk]
  connect_bd_net -net my_synth_0_i2s_lrck [get_bd_ports i2s_lrck_0] [get_bd_pins my_synth_0/i2s_lrck]
  connect_bd_net -net my_synth_0_i2s_mclk [get_bd_ports i2s_mclk_0] [get_bd_pins my_synth_0/i2s_mclk]
  connect_bd_net -net my_synth_0_i2s_tx [get_bd_ports i2s_tx_0] [get_bd_pins my_synth_0/i2s_tx]
  connect_bd_net -net my_synth_0_led_out [get_bd_ports led_out_0] [get_bd_pins my_synth_0/led_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_clk_wiz_0_98M/ext_reset_in] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_0_96M_peripheral_aresetn [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins my_synth_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins rst_clk_wiz_0_98M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_synth_0/S00_AXI/S00_AXI_reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"2.0",
   "Default View_TopLeft":"-202,-382",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0.21  2019-05-29 bk=1.5064 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1260 -y -20 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1260 -y 0 -defaultsOSRD
preplace port iic_rtl -pg 1 -lvl 4 -x 1260 -y 270 -defaultsOSRD
preplace port i2s_mclk_0 -pg 1 -lvl 4 -x 1260 -y 90 -defaultsOSRD
preplace port i2s_bclk_0 -pg 1 -lvl 4 -x 1260 -y 110 -defaultsOSRD
preplace port i2s_lrck_0 -pg 1 -lvl 4 -x 1260 -y 130 -defaultsOSRD
preplace port i2s_tx_0 -pg 1 -lvl 4 -x 1260 -y 150 -defaultsOSRD
preplace portBus led_out_0 -pg 1 -lvl 4 -x 1260 -y 70 -defaultsOSRD
preplace portBus iic_addr -pg 1 -lvl 4 -x 1260 -y 310 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 210 -y 60 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 1050 -y -140 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 2 -x 660 -y -120 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 2 -x 660 -y 270 -defaultsOSRD
preplace inst rst_clk_wiz_0_98M -pg 1 -lvl 2 -x 660 -y 100 -defaultsOSRD
preplace inst axi_iic_0 -pg 1 -lvl 3 -x 1050 -y 290 -defaultsOSRD
preplace inst my_synth_0 -pg 1 -lvl 3 -x 1050 -y 110 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 420 -140n
preplace netloc my_synth_0_led_out 1 3 1 NJ 70
preplace netloc my_synth_0_i2s_mclk 1 3 1 N 90
preplace netloc my_synth_0_i2s_bclk 1 3 1 N 110
preplace netloc my_synth_0_i2s_lrck 1 3 1 N 130
preplace netloc my_synth_0_i2s_tx 1 3 1 N 150
preplace netloc clk_wiz_0_clk_out1 1 1 2 440 -10 850
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 0 -80 410 -230 850
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 2 1 840 -180n
preplace netloc clk_wiz_0_locked 1 1 2 440 200 840
preplace netloc rst_clk_wiz_0_96M_peripheral_aresetn 1 2 1 860 -100n
preplace netloc axi_iic_0_iic2intc_irpt 1 0 4 0 380 NJ 380 NJ 380 1190
preplace netloc axi_iic_0_gpo 1 3 1 N 310
preplace netloc rst_ps7_0_100M_peripheral_reset 1 1 2 430 -240 830
preplace netloc axi_iic_0_IIC 1 3 1 N 270
preplace netloc processing_system7_0_DDR 1 1 3 NJ -20 840 0 1220
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 400 -220 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 2 870J 210 1210
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 2 870 370 1200
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 0 830 10 1230
levelinfo -pg 1 -20 210 660 1050 1260
pagesize -pg 1 -db -bbox -sgen -20 -280 1410 510
"
}
...
# End of cr_bd_synthesizer_bd()
cr_bd_synthesizer_bd ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files synthesizer_bd.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files synthesizer_bd.bd ] 
set_property IS_ENABLED "1" [get_files synthesizer_bd.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files synthesizer_bd.bd ] 
set_property IS_LOCKED "0" [get_files synthesizer_bd.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files synthesizer_bd.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files synthesizer_bd.bd ] 
set_property PFM_NAME "" [get_files synthesizer_bd.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files synthesizer_bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files synthesizer_bd.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files synthesizer_bd.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files synthesizer_bd.bd ] 
set_property USED_IN_SIMULATION "1" [get_files synthesizer_bd.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files synthesizer_bd.bd ] 
